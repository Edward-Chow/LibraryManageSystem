        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/reader.jsp"><strong>欢迎使用武汉理工大学图书馆管理系统</strong></a>
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/reader/borrowAction_queryBorrowSearchInfo.action" method="post">
                                ...
                                <div class="col-lg-5 form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" name="ISBN" type="text" value="" placeholder="请输入借阅图书的ISBN编号">
