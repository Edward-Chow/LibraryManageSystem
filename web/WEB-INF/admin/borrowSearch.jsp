                            ...
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/borrowSearchAction_queryBorrowSearchInfo.action" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control"  name="cardId" type="text" value="" placeholder="请输入读者证件号">
                                            <label class="control-label" for="borrow_sno" style="display: none"></label>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 form-group">
                    ...
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <s:if test="#request.pb.beanList!=null">
                            <s:iterator value="#request.pb.beanList" var="back">
                                ...
                                <td><s:property value="#back.borrowInfo.reader.cardId"/></td>
                                <td><s:property value="#back.borrowInfo.reader.name"/></td>
                                <td><s:date name="#back.borrowInfo.borrowDate" format="yyyy-MM-dd" /></td>
                                <td><s:date name="#back.backDay" format="yyyy-MM-dd" /></td>
                                <td><s:date name="#back.borrowInfo.returnDate" format="yyyy-MM-dd" /></td>
                                <td>
                    ...
                    <s:if test="#request.pb!=null">
                        ...
                        <div class="pull-right"><!--右对齐--->
                            <ul class="pagination">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/admin/borrowSearchAction_${pb.url }pageCode=1">首页</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/admin/borrowSearchAction_${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a>
                                </li><!-- 上一页 -->
                                    <%-- 循环显示页码列表 --%>
                                <c:forEach begin="${begin }" end="${end }" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/admin/borrowSearchAction_${pb.url }pageCode=${i}">${i}</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                ...
                                <c:if test="${pb.pageCode < pb.totaPage }">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/admin/borrowSearchAction_${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a>
                                    </li>
                                </c:if>
                                    <%--否则显示尾页 --%>
                                <li>
                                    <a href="${pageContext.request.contextPath}/admin/borrowSearchAction_${pb.url }pageCode=${pb.totaPage}">尾页</a>
                                </li>
                            </ul>
                        </div>
                    </s:if>
