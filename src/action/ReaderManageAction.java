...
public class ReaderManageAction extends ActionSupport {
    ...
    public String addReader(){
        ...
        Reader reader = new Reader(name, paperNO, password, phone, email, admin, type, createTime);

        Reader oldReader = readerService.getReaderByCardID(reader);//检查是否已经存在该paperNO的读者
        int success = 0;
        if(oldReader!=null){
            success = -1;//已存在该id
        }else{
    ...
    public String updateReader(){
        ...
        updateReader.setCardId(paperNO);
