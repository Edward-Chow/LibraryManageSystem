...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- content -->
        <div class="col-xs-11 col-lg-11 pull-right">
            <div class="row">
                <div class="col-lg-11">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/bookManageAction_queryBook.action" method="post">
                                ...
                                <div class="col-lg-5 form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="auth" name="auth" type="text" value="">
                    ...
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <s:if test="#request.pb.beanList!=null">
                            <s:iterator value="#request.pb.beanList" var="book">
                                ...
                                <td><s:property value="#book.auth"/></td>
                                <td><s:property value="#book.press"/></td>
                                <td><s:date name="#book.onDate" format="yyyy-MM-dd" /></td>
                                <td><s:property value="#book.totalNum"/></td>
                                <td><s:property value="#book.numInLibrary"/></td>
