...
$(function () {
    ...
    $('#addBook').click(function () {
        ...
        var postdata = "bookName="+$.trim($("#addBookName").val())+"&auth="+ $.trim($("#addAutho").val())+"&press="+ $.trim($("#addPress").val())+"&totalNum="+ $.trim($("#addNum").val())+"&price="+ $.trim($("#addPrice").val())+"&description="
